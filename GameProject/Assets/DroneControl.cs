	...
	void Update () {
        ...
        if (myPlayer.IsPlayerActive())
        {
            if(!IsHoldingPosition())
            {
                ...
                {
                    targetPosition = new Vector3(myPlayer.transform.position.x, myPlayer.transform.position.y + 2.4f, myPlayer.transform.position.z - 2);
                ...
                {
                    targetPosition = new Vector3(myPlayer.transform.position.x - 2, myPlayer.transform.position.y + 2.4f, myPlayer.transform.position.z + 2);
                    facing = 'd';
                }
                else
                {
